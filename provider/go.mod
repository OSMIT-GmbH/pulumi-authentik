module github.com/OSMIT-GmbH/pulumi-authentik/provider

go 1.18

replace (
	github.com/OSMIT-GmbH/terraform-provider-authentik/shim => ./shim
...
require (
	github.com/OSMIT-GmbH/terraform-provider-authentik/shim v0.0.0
...
require (
	...
	github.com/OSMIT-GmbH/terraform-provider-authentik v0.0.0-20230912084100-8f87c6cf556b // indirect
	...
	goauthentik.io/api/v3 v3.2023083.10 // indirect
