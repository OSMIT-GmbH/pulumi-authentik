...
namespace OSMIT_GmbH.Authentik
{
    ...
    public partial class PolicyEventMatcher : global::Pulumi.CustomResource
    {
        ...
        public PolicyEventMatcher(string name, PolicyEventMatcherArgs? args = null, CustomResourceOptions? options = null)
            : base("authentik:index/policyEventMatcher:PolicyEventMatcher", name, args ?? new PolicyEventMatcherArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PolicyEventMatcher(string name, Input<string> id, PolicyEventMatcherState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/policyEventMatcher:PolicyEventMatcher", name, state, MakeResourceOptions(options, id))
        {
        }
