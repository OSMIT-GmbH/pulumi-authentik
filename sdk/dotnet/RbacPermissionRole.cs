...
namespace OSMIT_GmbH.Authentik
{
    ...
    public partial class RbacPermissionRole : global::Pulumi.CustomResource
    {
        ...
        public RbacPermissionRole(string name, RbacPermissionRoleArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/rbacPermissionRole:RbacPermissionRole", name, args ?? new RbacPermissionRoleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RbacPermissionRole(string name, Input<string> id, RbacPermissionRoleState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/rbacPermissionRole:RbacPermissionRole", name, state, MakeResourceOptions(options, id))
        {
        }
