...
namespace OSMIT_GmbH.Authentik
{
    ...
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<int>> BackchannelProviders { get; private set; } = null!;
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("authentik:index/application:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, ApplicationState? state = null, CustomResourceOptions? options = null)
            : base("authentik:index/application:Application", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<int>? _backchannelProviders;
        public InputList<int> BackchannelProviders
        {
            get => _backchannelProviders ?? (_backchannelProviders = new InputList<int>());
