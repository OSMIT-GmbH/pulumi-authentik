...
namespace OSMIT_GmbH.Authentik
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/OSMIT-GmbH/pulumi-authentik/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("OSMIT_GmbH.Authentik.version.txt");
    ...
    internal sealed class AuthentikResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AuthentikResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
