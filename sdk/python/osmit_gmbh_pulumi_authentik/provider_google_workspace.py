...
class ProviderGoogleWorkspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] credentials: JSON format expected. Use jsonencode() to pass objects.
        :param pulumi.Input[str] group_delete_action: Allowed values: - `delete` - `do_nothing`
        :param pulumi.Input[str] user_delete_action: Allowed values: - `do_nothing` - `delete` - `suspend`
        """
