...
def get_users(attributes: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult).value
...
def get_users_output(attributes: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['uuid'] = uuid
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult)
