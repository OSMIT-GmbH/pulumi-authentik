...
class GetUserResult:
    ...
    def __init__(__self__, attributes=None, avatar=None, email=None, groups=None, id=None, is_active=None, is_superuser=None, last_login=None, name=None, path=None, pk=None, type=None, uid=None, username=None, uuid=None):
        ...
        if pk and not isinstance(pk, int):
            raise TypeError("Expected argument 'pk' to be a int")
...
def get_user(pk: Optional[int] = None,
    ...
    :param int pk: Generated.
    :param str username: Generated.
    """
    __args__ = dict()
    __args__['pk'] = pk
    __args__['username'] = username
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('authentik:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult).value
...
def get_user_output(pk: Optional[pulumi.Input[Optional[int]]] = None,
    ...
    __args__['username'] = username
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult)
