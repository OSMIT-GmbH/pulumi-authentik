...
class GetProviderOauth2ConfigResult:
    ...
    def __init__(__self__, authorize_url=None, id=None, issuer_url=None, jwks_url=None, logout_url=None, name=None, provider_id=None, provider_info_url=None, token_url=None, user_info_url=None):
        ...
        if provider_id and not isinstance(provider_id, int):
            raise TypeError("Expected argument 'provider_id' to be a int")
...
def get_provider_oauth2_config(name: Optional[str] = None,
    ...
    :param str name: Find provider by name
    :param int provider_id: Find provider by ID
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['providerId'] = provider_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('authentik:index/getProviderOauth2Config:getProviderOauth2Config', __args__, opts=opts, typ=GetProviderOauth2ConfigResult).value
...
def get_provider_oauth2_config_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                                      provider_id: Optional[pulumi.Input[Optional[int]]] = None,
    ...
    __args__['providerId'] = provider_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getProviderOauth2Config:getProviderOauth2Config', __args__, opts=opts, typ=GetProviderOauth2ConfigResult)
