...
class GetGroupsResult:
    ...
    def members_by_pks(self) -> Optional[Sequence[int]]:
...
def get_groups(attributes: Optional[str] = None,
               ...
               members_by_pks: Optional[Sequence[int]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult).value
...
def get_groups_output(attributes: Optional[pulumi.Input[Optional[str]]] = None,
                      ...
                      members_by_pks: Optional[pulumi.Input[Optional[Sequence[int]]]] = None,
    ...
    __args__['search'] = search
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult)
