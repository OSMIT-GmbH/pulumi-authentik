...
def get_certificate_key_pair(fetch_certificate: Optional[bool] = None,
    ...
    :param bool fetch_certificate: If set to true, certificate data will be fetched. Defaults to `true`.
    :param bool fetch_key: If set to true, private key data will be fetched. Defaults to `true`.
    :param str key_data: Generated.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getCertificateKeyPair:getCertificateKeyPair', __args__, opts=opts, typ=GetCertificateKeyPairResult).value
...
def get_certificate_key_pair_output(fetch_certificate: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getCertificateKeyPair:getCertificateKeyPair', __args__, opts=opts, typ=GetCertificateKeyPairResult)
