...
class StageUserWriteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] user_creation_mode: Allowed values: - `never_create` - `create_when_required` - `always_create`
        :param pulumi.Input[str] user_type: Allowed values: - `internal` - `external` - `service_account`
        """
