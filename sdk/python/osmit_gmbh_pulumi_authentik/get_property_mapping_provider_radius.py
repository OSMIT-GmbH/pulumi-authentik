...
def get_property_mapping_provider_radius(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getPropertyMappingProviderRadius:getPropertyMappingProviderRadius', __args__, opts=opts, typ=GetPropertyMappingProviderRadiusResult).value
...
def get_property_mapping_provider_radius_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getPropertyMappingProviderRadius:getPropertyMappingProviderRadius', __args__, opts=opts, typ=GetPropertyMappingProviderRadiusResult)
