...
class RacEndpointArgs:
    def __init__(__self__, *,
                 ...
                 protocol_provider: pulumi.Input[int],
                 maximum_connections: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[str] settings: JSON format expected. Use jsonencode() to pass objects.
        """
...
class _RacEndpointState:
    def __init__(__self__, *,
                 ...
                 protocol_provider: Optional[pulumi.Input[int]] = None,
                 settings: Optional[pulumi.Input[str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="protocolProvider")
    def protocol_provider(self) -> Optional[pulumi.Input[int]]:
        return pulumi.get(self, "protocol_provider")

    @protocol_provider.setter
    def protocol_provider(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "protocol_provider", value)
...
class RacEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="maximumConnections")
    def maximum_connections(self) -> pulumi.Output[Optional[int]]:
        return pulumi.get(self, "maximum_connections")
    ...
    @property
    @pulumi.getter(name="protocolProvider")
    def protocol_provider(self) -> pulumi.Output[int]:
        return pulumi.get(self, "protocol_provider")
