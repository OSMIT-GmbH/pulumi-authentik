...
class StagePasswordArgs:
    def __init__(__self__, *,
                 ...
                 failed_attempts_before_cancel: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[int] failed_attempts_before_cancel: Defaults to `5`.
        """
    ...
    def failed_attempts_before_cancel(self) -> Optional[pulumi.Input[int]]:
        """
        Defaults to `5`.
        """
    ...
    def failed_attempts_before_cancel(self, value: Optional[pulumi.Input[int]]):
...
class StagePassword(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            configure_flow: Optional[pulumi.Input[str]] = None,
            failed_attempts_before_cancel: Optional[pulumi.Input[int]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'StagePassword':
        """
    ...
    @property
    @pulumi.getter(name="failedAttemptsBeforeCancel")
    def failed_attempts_before_cancel(self) -> pulumi.Output[Optional[int]]:
        """
        Defaults to `5`.
        """
        return pulumi.get(self, "failed_attempts_before_cancel")
