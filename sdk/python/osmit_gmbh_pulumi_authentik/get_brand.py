...
def get_brand(branding_favicon: Optional[str] = None,
    ...
    :param str branding_favicon: Generated.
    :param str branding_logo: Generated.
    :param str branding_title: Generated.
    :param bool default: Generated.
    :param str default_application: Generated.
    :param str domain: Generated.
    :param str flow_authentication: Generated.
    :param str flow_device_code: Generated.
    :param str flow_invalidation: Generated.
    :param str flow_recovery: Generated.
    :param str flow_unenrollment: Generated.
    :param str flow_user_settings: Generated.
    :param str web_certificate: Generated.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getBrand:getBrand', __args__, opts=opts, typ=GetBrandResult).value
...
def get_brand_output(branding_favicon: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['webCertificate'] = web_certificate
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getBrand:getBrand', __args__, opts=opts, typ=GetBrandResult)
