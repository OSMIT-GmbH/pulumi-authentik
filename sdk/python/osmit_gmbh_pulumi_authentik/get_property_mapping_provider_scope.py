...
def get_property_mapping_provider_scope(ids: Optional[Sequence[str]] = None,
    ...
    :param str scope_name: Generated.
    """
    __args__ = dict()
    __args__['ids'] = ids
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getPropertyMappingProviderScope:getPropertyMappingProviderScope', __args__, opts=opts, typ=GetPropertyMappingProviderScopeResult).value
...
def get_property_mapping_provider_scope_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __args__['scopeName'] = scope_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getPropertyMappingProviderScope:getPropertyMappingProviderScope', __args__, opts=opts, typ=GetPropertyMappingProviderScopeResult)
