...
class StageAuthenticatorStaticArgs:
    def __init__(__self__, *,
                 ...
                 token_count: Optional[pulumi.Input[int]] = None,
                 token_length: Optional[pulumi.Input[int]] = None):
        """
        The set of arguments for constructing a StageAuthenticatorStatic resource.
        :param pulumi.Input[int] token_count: Defaults to `6`.
        :param pulumi.Input[int] token_length: Defaults to `12`.
        """
    ...
    def token_count(self) -> Optional[pulumi.Input[int]]:
        """
        Defaults to `6`.
        """
    ...
    @token_count.setter
    def token_count(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "token_count", value)

    @property
    @pulumi.getter(name="tokenLength")
    def token_length(self) -> Optional[pulumi.Input[int]]:
        """
        Defaults to `12`.
        """
    ...
    @token_length.setter
    def token_length(self, value: Optional[pulumi.Input[int]]):
...
class StageAuthenticatorStatic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            token_count: Optional[pulumi.Input[int]] = None,
            token_length: Optional[pulumi.Input[int]] = None) -> 'StageAuthenticatorStatic':
        """
    ...
    @property
    @pulumi.getter(name="tokenCount")
    def token_count(self) -> pulumi.Output[Optional[int]]:
        """
        Defaults to `6`.
        """
        return pulumi.get(self, "token_count")
    ...
    @property
    @pulumi.getter(name="tokenLength")
    def token_length(self) -> pulumi.Output[Optional[int]]:
        """
        Defaults to `12`.
        """
        return pulumi.get(self, "token_length")
