...
def get_property_mapping_provider_rac(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getPropertyMappingProviderRac:getPropertyMappingProviderRac', __args__, opts=opts, typ=GetPropertyMappingProviderRacResult).value
...
def get_property_mapping_provider_rac_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __args__['settings'] = settings
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getPropertyMappingProviderRac:getPropertyMappingProviderRac', __args__, opts=opts, typ=GetPropertyMappingProviderRacResult)
