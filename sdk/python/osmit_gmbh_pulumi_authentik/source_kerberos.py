...
class SourceKerberosArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] password_login_update_internal_password: If enabled, the authentik-stored password will be updated upon login with the Kerberos password backend
        ...
        :param pulumi.Input[bool] sync_users: Sync users from Kerberos into authentik
        :param pulumi.Input[bool] sync_users_password: When a user changes their password, sync it back to Kerberos
