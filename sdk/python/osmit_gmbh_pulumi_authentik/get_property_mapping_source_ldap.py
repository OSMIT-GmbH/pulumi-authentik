...
def get_property_mapping_source_ldap(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getPropertyMappingSourceLdap:getPropertyMappingSourceLdap', __args__, opts=opts, typ=GetPropertyMappingSourceLdapResult).value
...
def get_property_mapping_source_ldap_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getPropertyMappingSourceLdap:getPropertyMappingSourceLdap', __args__, opts=opts, typ=GetPropertyMappingSourceLdapResult)
