...
def get_flow(authentication: Optional[str] = None,
    ...
    :param str authentication: Generated.
    :param str designation: Generated.
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getFlow:getFlow', __args__, opts=opts, typ=GetFlowResult).value
...
def get_flow_output(authentication: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['slug'] = slug
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getFlow:getFlow', __args__, opts=opts, typ=GetFlowResult)
