...
VERSION = "2024.0.0a0+dev"
def readme():
    try:
        with open('README.md', encoding='utf-8') as f:
            return f.read()
    except FileNotFoundError:
        return "authentik Pulumi Package - Development Version"


setup(name='osmit_gmbh_pulumi_authentik',
      python_requires='>=3.8',
      version=VERSION,
      description="A Pulumi package for creating and managing authentik cloud resources.",
      long_description=readme(),
      long_description_content_type='text/markdown',
      keywords='pulumi authentik category/cloud',
