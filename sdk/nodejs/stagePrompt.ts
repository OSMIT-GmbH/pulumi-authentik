...
export class StagePrompt extends pulumi.CustomResource {
    ...
    public readonly validationPolicies!: pulumi.Output<string[] | undefined>;
    ...
    constructor(name: string, argsOrState?: StagePromptArgs | StagePromptState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["validationPolicies"] = state ? state.validationPolicies : undefined;
        } else {
            ...
            resourceInputs["validationPolicies"] = args ? args.validationPolicies : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(StagePrompt.__pulumiType, name, resourceInputs, opts);
    }
}
